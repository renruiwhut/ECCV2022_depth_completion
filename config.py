...
parser.add_argument('--data_dir',
                    type=str,
                    default='../../dataset/Depth_Estimation/train',
...
parser.add_argument('--pretrain_step2',
                    type=str,
                    default=None,
                    help='path of pretrained model')
...
# Train_step2
parser.add_argument('--train_step2',
                    action='store_true',
                    default=False,
                    help='train_step2')
...
parser.add_argument('--test_only',
                    ...
                    default=False,
                    help='test only flag')
parser.add_argument('--test_only_step2',
                    action='store_true',
                    default=False,
                    help='test only flag')
...
save_dir = 'experiments/' + args.save + current_time
